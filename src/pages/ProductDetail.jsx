  ...
  <div className="animate-pulse grid grid-cols-1 lg:grid-cols-2 gap-10">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-5 gap-2">
        {[...Array(5)].map((_, i) => (
          <div key={i} className="h-12 bg-zinc-100 rounded-xl"></div>
        ))}
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-32">
            <p className="text-3xl font-black italic uppercase text-zinc-300">
              Produit introuvable
            </p>
            <button
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center bg-white border border-zinc-200 rounded-xl overflow-hidden shadow-sm">
                      ...
                      <span className="font-black text-sm px-4 min-w-[40px] text-center text-zinc-900">
                        {qty}
                      </span>
                      <button
                  ...
                  >
                    <i
                      className={`fa-solid ${
                        addedFeedback ? "fa-check" : "fa-bag-shopping"
                      } text-sm`}
                    ></i>
                    <span>
                      {addedFeedback
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <div
                      key={item.title}
                      className={`${item.bg} border rounded-xl p-3 text-center hover:shadow-sm transition-all`}
                    >
                      <i
                        className={`fa-solid ${item.icon} ${item.color} text-sm mb-1 block`}
                      ></i>
                      <p className="text-[9px] font-black uppercase text-zinc-700 leading-tight">
                        {item.title}
                      </p>
              ...
              {activeTab === "specs" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl">
                  {(product.features?.length > 0
                    ? product.features
                    : [
                        "Qualité Elite Certifiée",
                        "Design OneFreestyle Exclusif",
                        "Livraison Express Douala",
                        "Retour sous 7 jours",
                      ]
                  ).map((feat, i) => (
                    <div
                    ...
                    >
                      ...
                      <span className="text-[11px] font-bold text-zinc-500 group-hover:text-zinc-900 transition-colors uppercase">
                        {feat}
                      </span>
                    </div>
                  ))}
                ...
                <div className="max-w-2xl space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-4">
                    {[
                      ...
                      <div
                        key={item.label}
                        className="flex justify-between items-center py-3 border-b border-zinc-100 text-[11px]"
                      >
                        <span className="font-black uppercase text-zinc-400 tracking-wider">
                          {item.label}
                        </span>
                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-1">
                        <h4 className="font-black text-xl uppercase italic tracking-tighter text-zinc-900">
                          {vendor.shop_name}
                        </h4>
                        <span className="bg-primary/10 text-primary border border-primary/20 text-[8px] font-black px-2 py-0.5 rounded-full uppercase">
                          Certifié
                        </span>
                      </div>
                      <p className="text-zinc-400 text-[11px] font-bold mb-2">
                        {vendor.full_name} · Douala, Cameroun 🇨🇲
                      </p>
                      <div className="flex items-center gap-4 text-[9px] font-black uppercase text-zinc-400">
                        ...
                        <span>
                          <i className="fa-solid fa-truck-fast text-blue-400 mr-1"></i>
                          Livraison express
                        </span>
                      </div>
                    </div>
