    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      <div className="bg-white border border-[#D5D9D9] rounded overflow-hidden">
        <div className="bg-[#232F3E] px-6 py-5">
          ...
          <p className="text-[#ADBAC7] text-xs mt-1">OneFreestyle Store (OFS) · Douala, Cameroun · Mise à jour : juin 2026</p>
        </div>
        <div className="p-6 md:p-8">

          <Section title="1. Vendeur">
            <p>OneFreestyle Store (OFS / Buyticle ETS), entreprise de commerce électronique basée à Douala, Cameroun.</p>
            <p>Contact : via WhatsApp ou email disponible sur le site.</p>
          </Section>
          ...
          <Section title="2. Produits">
            ...
            <p>OFS se réserve le droit de modifier les prix à tout moment, mais les produits seront facturés sur la base des tarifs en vigueur au moment de la validation de la commande.</p>
          </Section>

          <Section title="3. Commande">
            <p>Toute commande passée sur OFS vaut acceptation des présentes CGV. La commande est confirmée par email ou SMS dès sa validation.</p>
            <p>OFS se réserve le droit d'annuler toute commande en cas de stock indisponible ou d'erreur manifeste de prix.</p>
          </Section>
          ...
          <Section title="7. Programme de fidélité OFS Rewards">
            <p>Les points OFS sont crédités à titre commercial et n'ont aucune valeur monétaire en dehors du programme. OFS se réserve le droit de modifier ou d'arrêter le programme à tout moment.</p>
          </Section>

          <Section title="8. Programme d'affiliation">
            <p>Les commissions d'affiliation (5% du montant de la commande) sont versées selon les conditions définies dans l'espace parrain. OFS se réserve le droit de refuser toute commission en cas d'utilisation frauduleuse du code de parrainage.</p>
          </Section>
          ...
          <Section title="9. Données personnelles">
            ...
            <p>Conformément à la loi camerounaise sur les données personnelles, vous disposez d'un droit d'accès, de rectification et de suppression de vos données.</p>
          </Section>

          <Section title="10. Litiges">
            <p>En cas de litige, une solution amiable sera recherchée en priorité. À défaut, les tribunaux compétents de Douala (Cameroun) seront saisis.</p>
          </Section>

          <div className="mt-8 pt-6 border-t border-[#D5D9D9] flex items-center justify-between flex-wrap gap-4">
            <p className="text-[10px] text-[#565959]">© 2026 OneFreestyle Store · Tous droits réservés</p>
