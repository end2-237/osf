...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.message.includes('Maximum')) {
        setError('Limite de 5 vendeurs atteinte. Contactez l\'administrateur.');
      } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-black p-6 pt-24 pb-12">
      <div className="w-full max-w-2xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 p-10 rounded-[3rem] shadow-2xl animate-fadeIn">
