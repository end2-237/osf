...
const CATS = [
  ...
  },
  {
    ...
    catKey: "Bien-être",
    icon:   "fa-spa",
    img:    "https://images.unsplash.com/photo-1600334129128-685c5582fd35?q=80&w=400",
    count:  "50+",
    isNew:  true,
  },
  {
    ...
    catKey: "Santé",
    icon:   "fa-heart-pulse",
    img:    "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?q=80&w=400",
    count:  "35+",
    isNew:  true,
  },
  {
    ...
    catKey: "Nutrition",
    icon:   "fa-apple-whole",
    img:    "https://images.unsplash.com/photo-1490645935967-10de6ba17061?q=80&w=400",
    count:  "45+",
    isNew:  true,
  },
  {
