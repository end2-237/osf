  ...
  return (
    <>
      ...
      {open && (
        <>
          {/* Backdrop */}
          <div className="fixed inset-0 z-[199] bg-black/30" onClick={() => { setOpen(false); reset(); }} />

          {/* Bottom drawer — 80vh */}
          <div className="fixed bottom-0 left-0 right-0 z-[200] bg-white flex flex-col animate-[slideUp_0.25s_ease-out]"
            style={{ height: '80vh', borderTopLeftRadius: '12px', borderTopRightRadius: '12px', boxShadow: '0 -4px 30px rgba(0,0,0,0.15)' }}>

            {/* Top bar */}
            <div className="flex items-center gap-2 px-4 py-2 border-b border-[#E7E7E7] flex-shrink-0" style={{ borderTopLeftRadius: '12px', borderTopRightRadius: '12px' }}>
